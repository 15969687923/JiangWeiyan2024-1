<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="borbook.aspx.cs" Inherits="borbook" %>
    ...
    <asp:UpdatePanel runat ="server" >
        <ContentTemplate>
            <div  style="margin-top:50px;margin-left:160px;" >
                ...
                <asp:Button ID="addp" runat ="server" Text="借出" Height="28px" OnClick="bookbor"/>
                <br /><br /><br /><br />
            </div> 
