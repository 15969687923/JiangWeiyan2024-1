<%@ Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="losebook.aspx.cs" Inherits="losebook" %>
    ...
    <asp:UpdatePanel runat ="server" >
        <ContentTemplate>
            <div  style="margin-top:50px;margin-left:160px;" >
                ...
                <asp:Button ID="Button1" runat ="server" Text="查询书籍价格" Height="28px" OnClick="bookprice"/>
                <br /><br />
                <asp:Label runat ="server" Text="书籍价格:￥"></asp:Label>
                <asp:Label runat ="server" Text="" ID="price"></asp:Label>
                <br /><br />
                <asp:Label runat ="server" Text="读者编号:"></asp:Label>
                <%--查询记录存放在session里--%>
                <%--<% if (Session["PID"] != null) { personid.Text = Session["PID"].ToString();} %>--%>
                <asp:TextBox runat="server" ID="personid"  Width="200px" Height="22px"  ></asp:TextBox>
                <asp:Button ID="addp" runat ="server" Text="已赔偿书籍" Height="28px" OnClick="booklose"/>
                <br /><br /><br /><br />
            </div> 
