...
public partial class subbook : BasePage
{
    ...
    protected void booksub(object sender, EventArgs e)
    {
        if (bookid.Text == "")
        {
        ...
        else
        {
            ...
            if (i == 1)
            {
                ...
                com2.CommandText = "update book set ifborrowed='2' where bookid='" + bookid.Text + "'";
                com2.CommandType = CommandType.Text;
                com2.ExecuteNonQuery();                          //执行语句

                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "onekey", "alert('此书已停止借阅');window.location.reload(); ", true);
