<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="subbook.aspx.cs" Inherits="subbook" %>
    ...
    <asp:UpdatePanel runat ="server" >
        <ContentTemplate>
            <div  style="margin-top:50px;margin-left:160px;" >
                ...
                <asp:Button ID="addp" runat ="server" Text="停止借阅" Height="28px" OnClick="booksub"/>
                <br /><br /><br /><br />
            </div> 
