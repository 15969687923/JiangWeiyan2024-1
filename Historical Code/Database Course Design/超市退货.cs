...
namespace 数据库课设
{
    public partial class 超市退货 : Form
    {
        ...
        private void tuihuo_Load(object sender, EventArgs e)
        {
            ...
            myconn.Open();//打开数据库
            string contain = "select * FROM 退货表"; //获取TestSave表的数据信息
            SqlCommand cmd = new SqlCommand(contain, myconn); //执行sqlcommand命令，就可以执行sql命令了
            DataSet myds = new DataSet();
            SqlDataAdapter myda = new SqlDataAdapter(cmd);
            myda.Fill(myds, "退货表");
            mydv = myds.Tables["退货表"].DefaultView;//获得DataView对象mydv;
            ...
            dataGridView1.Columns[1].HeaderCell.Value = "退货日期";
            dataGridView1.Columns[2].HeaderCell.Value = "退货商品编号";
            dataGridView1.Columns[3].HeaderCell.Value = "退货数量";
            dataGridView1.Columns[4].HeaderCell.Value = "商品金额";
            dataGridView1.Columns[5].HeaderCell.Value = "退货总价";
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //com.CommandText = "INSERT  INTO 退货表(Retnum,Retreatdate,Rgno,Amount,Remoney,Rtp) VAlUES('" +
